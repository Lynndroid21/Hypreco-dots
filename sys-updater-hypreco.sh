...
install_HEdots() {
    ...
    command cp -r -v $PATH_TO_GIT_CLONE/configs/fastfetch $DOTS_INSTALL_DIR
    ...
    command cp -r -v $PATH_TO_GIT_CLONE/configs/hyprpanel $DOTS_INSTALL_DIR
    command cp -r -v $PATH_TO_GIT_CLONE/configs/kitty $DOTS_INSTALL_DIR
    command cp -r -v $PATH_TO_GIT_CLONE/configs/matugen $DOTS_INSTALL_DIR
    command cp -r -v $PATH_TO_GIT_CLONE/configs/rofi $DOTS_INSTALL_DIR
    command cp -v $PATH_TO_GIT_CLONE/configs/background.jpg $DOTS_INSTALL_DIR
